...
```shell
git clone https://github.com/andike82/qubtTemplate
```
...
`hugo.yaml`:
```yaml
baseURL: 'https://andike82.github.io/qubtTemplate'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/andike82/qubtTemplate
  - link: https://github.com/andike82/qubtTemplate#readme
...
`https://andike82.github.io/qubtTemplate`